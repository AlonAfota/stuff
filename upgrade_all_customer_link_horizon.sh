...
probe_name=(COMPORIUM-LINK-1 WESTMAN-LINK-1 ROGERS-LINK-1 TIGO-GUATEMALA-LINK-1 INTER-MOUNTAIN-LINK-1 TIGO-PARAGUAY-LINK-1 TIGO-COLOMBIA-LINK-1 ACCESS-COMM-LINK-1 DNA-LINK-1 NAL-LINK-1 TWT-LINK-1)
probe_array=(00-50-56-91-59-8d 00-50-56-99-03-de 00-50-56-a3-66-c5 94-40-c9-49-6b-b4 d8-eb-97-b9-aa-4b fa-16-3e-d7-12-5f 00-50-56-b1-a0-40 94-40-c9-49-72-24 48-df-37-a4-e6-70 00-50-56-aa-05-65 94-40-c9-4c-9b-50)

b=0
for i in "${probe_name[@]}"
do
	echo -e "\E[1;33m Updating $i \033[1m\033[0m"
